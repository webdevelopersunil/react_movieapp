                    ...
                    <div className="right" >
                        ...
                        <div className="footer" >
                            ...
                            <div className="star-dis" >
                                <img onClick={this.decStars} className="str-btn" alt="decrease" src="https://cdn-icons-png.flaticon.com/128/2801/2801932.png" />
                            ...
                            <button className= {cart?"uncart-btn" : "cart-btn"} onClick={this.handleCart} >{cart?"Remove from cart" : "Add to Cart"}</button>
                        </div>
                    </div>
